    ...
    <div v-if="event" class="w-full max-w-5xl mx-auto">
      ...
      <div class="p-4">
        <dl class="grid grid-cols-2 gap-4">
          <div>
            <dt class="font-medium text-sm text-merino-500">
              Short Name
            </dt>
            <dd class="text-lg">
              {{ event.shortName }}
      ...
      <div class="px-4 flex flex-col gap-8">
        ...
        <section class="flex flex-col gap-4">
          ...
          <ul class="flex flex-col gap-4">
            <li>
              <button class="px-2 py-1 bg-red-600 rounded-md text-white font-medium">
                Close event early
              </button>
              <p>
                This will update the end date and guest will be not able to upload pictures anymore but it's still
            ...
            <li>
              <form @submit.prevent="deleteEvent">
                <fieldset>
                  <button type="submit" class="px-2 py-1 bg-red-600 rounded-md text-white font-medium">
                    Delete
                    Event
                  </button>
                </fieldset>
