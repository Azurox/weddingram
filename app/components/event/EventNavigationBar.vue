    ...
    <menu class="flex gap-6 items-center justify-between max-w-96 w-full mx-auto px-6">
      ...
      <li>
        <NuxtLink :to="`/event/${uuid}/upload`" class="py-3 px-4 flex items-center justify-center group" active-class="active">
          <svg class="size-7 block text-neutral-600 group-[.active]:hidden" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 14 14"><!-- Icon from Streamline by Streamline - https://creativecommons.org/licenses/by/4.0/ --><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M7 4v6M4 7h6" /><rect width="13" height="13" x=".5" y=".5" rx="3" /></g></svg>
          <svg class="size-7 hidden text-almond-500 group-[.active]:block" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 14 14"><!-- Icon from Streamline by Streamline - https://creativecommons.org/licenses/by/4.0/ --><path fill="currentColor" fill-rule="evenodd" d="M0 3.5A3.5 3.5 0 0 1 3.5 0h7A3.5 3.5 0 0 1 14 3.5v7a3.5 3.5 0 0 1-3.5 3.5h-7A3.5 3.5 0 0 1 0 10.5zm7-.25a.75.75 0 0 1 .75.75v2.25H10a.75.75 0 0 1 0 1.5H7.75V10a.75.75 0 0 1-1.5 0V7.75H4a.75.75 0 0 1 0-1.5h2.25V4A.75.75 0 0 1 7 3.25" clip-rule="evenodd" /></svg>
