...
<template>
  <div class="flex flex-col gap-2">
    ...
    <div class="flex gap-2">
      <button class="px-2 py-1 bg-white rounded-md font-medium border border-merino-400" @click="generateQrCode(256)">
        256px
      </button>
      <button class="px-2 py-1 bg-white rounded-md font-medium border border-merino-400" @click="generateQrCode(512)">
        512px
      </button>
      <button class="px-2 py-1 bg-white rounded-md font-medium border border-merino-400" @click="generateQrCode(1024)">
        1024px
      </button>
    </div>
